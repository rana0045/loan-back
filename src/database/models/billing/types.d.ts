...
export namespace Billing {
  ...
  export type IBillingType = 'full' | 'downPayment' | 'emi' | null;
  export interface IModuleOne {
    _id: TString;
    user_id: Types.ObjectId | null | undefined;
    billingType: IBillingType;
    package_id: Types.ObjectId | null | undefined;
    payment_id: Types.ObjectId | null | undefined;
    invoice_id: Types.ObjectId | null | undefined;
    status: TStatus;
