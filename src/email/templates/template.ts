...
export class Template {
  static sendEmail = async (data?: Type.ITemplate) => {
  ...
  static forgotPassword = async (props?: Type.ITemplate) => {
    try {
...
<body>
  ...
  static resetDone = async (props?: Type.ITemplate) => {
    try {
      const res = await this.sendEmail({
        to: props?.to,
...
`,
  ...
  static setNewPassword = async (props?: Type.ITemplate) => {
    try {
      const res = await this.sendEmail({
        to: props?.to,
...
`,
  ...
  static accountCreatedSuccessful = async (props?: Type.ITemplate) => {
    try {
      const details = await CheckUserHelper.bothUserDetailsCredentials(
        props?.userId,
      );
      const res = await this.sendEmail({
...
`,
  ...
  static userPasswordSuccessfully = async (props?: Type.ITemplate) => {
    try {
      const details = await CheckUserHelper.bothUserDetailsCredentials(
        props?.userId,
      );
