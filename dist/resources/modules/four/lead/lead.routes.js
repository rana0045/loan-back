...
import { LeadControllerFour } from './lead.controller.js';
export var FourLeadRoutes;
(function (FourLeadRoutes) {
    FourLeadRoutes.index = Router();
    FourLeadRoutes.index.post('/modules/four.lead.request', [
