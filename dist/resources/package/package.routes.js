...
export var PackageRoutes;
(function (PackageRoutes) {
    PackageRoutes.index = Router();
    PackageRoutes.index.post('/package', [
        validateRequest(PackageValidation.MPackage),
        PackageController.PackageAdd,
    ]);
    PackageRoutes.index.put('/package/:id', [
        validateRequest(PackageValidation.MPackageUpdate),
        PackageController.PackageUpdate,
    ]);
    PackageRoutes.index.get('/package', [PackageController.PackageList]);
    PackageRoutes.index.delete('/package/:id');
