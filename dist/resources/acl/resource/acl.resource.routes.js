...
export var AclResourceRoutes;
(function (AclResourceRoutes) {
    AclResourceRoutes.index = Router();
    AclResourceRoutes.index.post('/acl.resources', [AclResourceController.ResourceAdd]);
